...
The three bundled scene illustrations were created specifically for this project on 9 August 2026 with OpenAI's built-in image-generation tool, using prompts written for this project. They are stored as static WebP files and no image-generation service is used during gameplay.
